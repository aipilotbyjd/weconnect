...
export class ExecutionsController {
  ...
  @ApiResponse({ status: 201, description: 'Execution started successfully', type: Execution })
  ...
  startExecution(
    ...
    return this.executionsService.startExecution(workflowId, startExecutionDto, req.user.id);
  }

  @Get()
  @ApiOperation({ summary: 'Get all executions for current user' })
  @ApiResponse({ status: 200, description: 'Executions retrieved successfully', type: [Execution] })
  ...
  @ApiResponse({ status: 200, description: 'Execution retrieved successfully', type: Execution })
  ...
  @ApiResponse({ status: 200, description: 'Execution logs retrieved successfully', type: [ExecutionLog] })
  @ApiResponse({ status: 404, description: 'Execution not found' })
  ...
  @ApiResponse({ status: 200, description: 'Execution cancelled successfully', type: Execution })
  @ApiResponse({ status: 400, description: 'Cannot cancel completed execution' })
  cancelExecution(@Param('id') id: string, @Req() req: any): Promise<Execution> {
