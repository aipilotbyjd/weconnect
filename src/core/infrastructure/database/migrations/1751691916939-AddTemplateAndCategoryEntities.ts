...
export class AddTemplateAndCategoryEntities1751691916939
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."organizations_plan_enum" AS ENUM('free', 'starter', 'pro', 'enterprise')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."organization_members_role_enum" AS ENUM('owner', 'admin', 'member', 'guest')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "template_categories_mapping" ("templateId" uuid NOT NULL, "categoryId" uuid NOT NULL, CONSTRAINT "PK_7dceabb8549057f037810f5e1da" PRIMARY KEY ("templateId", "categoryId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0f5cb0c57b146ef279e9cf29b4" ON "template_categories_mapping" ("templateId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ce245ae45dbaa4eace64e05112" ON "template_categories_mapping" ("categoryId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "template_categories_closure" ("id_ancestor" uuid NOT NULL, "id_descendant" uuid NOT NULL, CONSTRAINT "PK_fa98db63a8d4c350c10f97df5e1" PRIMARY KEY ("id_ancestor", "id_descendant"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_40b4ef51fc86d15b689379150a" ON "template_categories_closure" ("id_ancestor") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_254707fce4f5c52b01440b3af3" ON "template_categories_closure" ("id_descendant") `,
    );
    // Add columns as nullable first
    await queryRunner.query(
      `ALTER TABLE "credentials" ADD "organizationId" uuid`,
    );
    await queryRunner.query(`ALTER TABLE "credentials" ADD "sharing" json`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD "currentOrganizationId" uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO "organizations" ("id", "slug", "name", "description") VALUES (uuid_generate_v4(), 'default-org', 'Default Organization', 'Default organization for existing users')`,
    );
    ...
    await queryRunner.query(
      `UPDATE "credentials" SET "organizationId" = $1 WHERE "organizationId" IS NULL`,
      [defaultOrgId],
    );
    await queryRunner.query(
      `UPDATE "workflows" SET "organizationId" = $1 WHERE "organizationId" IS NULL`,
      [defaultOrgId],
    );
    ...
    await queryRunner.query(`UPDATE "users" SET "currentOrganizationId" = $1`, [
      defaultOrgId,
    ]);
    ...
    await queryRunner.query(
      `ALTER TABLE "credentials" ADD CONSTRAINT "FK_693d053d2009de2741907423e18" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_d9cefcee01b771dd297c4d383cf" FOREIGN KEY ("currentOrganizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflows" ADD CONSTRAINT "FK_e5b97c3123140983764e48265f8" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories" ADD CONSTRAINT "FK_5a2efb45db330e39fedb91b33a3" FOREIGN KEY ("parentId") REFERENCES "template_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_reviews" ADD CONSTRAINT "FK_b428241a0e53c9c39c9283dd1e7" FOREIGN KEY ("templateId") REFERENCES "workflow_templates"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_reviews" ADD CONSTRAINT "FK_236b5acdcea32e5c9314b69d744" FOREIGN KEY ("reviewerId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_reviews" ADD CONSTRAINT "FK_ac1272f5cd8d2d1b4007810107f" FOREIGN KEY ("moderatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflow_templates" ADD CONSTRAINT "FK_55aa996e03a343601b90c72a1f3" FOREIGN KEY ("creatorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflow_templates" ADD CONSTRAINT "FK_832e303ee037faf1221334f8787" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories_mapping" ADD CONSTRAINT "FK_0f5cb0c57b146ef279e9cf29b40" FOREIGN KEY ("templateId") REFERENCES "workflow_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories_mapping" ADD CONSTRAINT "FK_ce245ae45dbaa4eace64e051127" FOREIGN KEY ("categoryId") REFERENCES "template_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories_closure" ADD CONSTRAINT "FK_40b4ef51fc86d15b689379150a3" FOREIGN KEY ("id_ancestor") REFERENCES "template_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories_closure" ADD CONSTRAINT "FK_254707fce4f5c52b01440b3af3b" FOREIGN KEY ("id_descendant") REFERENCES "template_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "template_categories_closure" DROP CONSTRAINT "FK_254707fce4f5c52b01440b3af3b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories_closure" DROP CONSTRAINT "FK_40b4ef51fc86d15b689379150a3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories_mapping" DROP CONSTRAINT "FK_ce245ae45dbaa4eace64e051127"`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories_mapping" DROP CONSTRAINT "FK_0f5cb0c57b146ef279e9cf29b40"`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflow_templates" DROP CONSTRAINT "FK_832e303ee037faf1221334f8787"`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflow_templates" DROP CONSTRAINT "FK_55aa996e03a343601b90c72a1f3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_reviews" DROP CONSTRAINT "FK_ac1272f5cd8d2d1b4007810107f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_reviews" DROP CONSTRAINT "FK_236b5acdcea32e5c9314b69d744"`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_reviews" DROP CONSTRAINT "FK_b428241a0e53c9c39c9283dd1e7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "template_categories" DROP CONSTRAINT "FK_5a2efb45db330e39fedb91b33a3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "workflows" DROP CONSTRAINT "FK_e5b97c3123140983764e48265f8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_d9cefcee01b771dd297c4d383cf"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "credentials" DROP CONSTRAINT "FK_693d053d2009de2741907423e18"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN "currentOrganizationId"`,
    );
    await queryRunner.query(`ALTER TABLE "credentials" DROP COLUMN "sharing"`);
    await queryRunner.query(
      `ALTER TABLE "credentials" DROP COLUMN "organizationId"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_254707fce4f5c52b01440b3af3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_40b4ef51fc86d15b689379150a"`,
    );
    await queryRunner.query(`DROP TABLE "template_categories_closure"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ce245ae45dbaa4eace64e05112"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0f5cb0c57b146ef279e9cf29b4"`,
    );
    await queryRunner.query(`DROP TABLE "template_categories_mapping"`);
    await queryRunner.query(`DROP TABLE "workflow_templates"`);
    await queryRunner.query(
      `DROP TYPE "public"."workflow_templates_tier_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."workflow_templates_visibility_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."workflow_templates_status_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_97ebd4735fbc7445e738cabc89"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3a0dff1be3d7c492e55dbb568b"`,
    );
